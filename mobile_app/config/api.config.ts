...
const getBaseURL = (): string => {
    const url = getEnvVar('API_BASE_URL', 'http://192.168.29.140:8000/api/v1');
...
if (isDevelopment) {
    ...
    if (Platform.OS === 'android') {
        console.log('💡 Host Machine IP: 192.168.29.140');
        console.log('💡 Physical Device / Emulator: Using http://192.168.29.140:8000/api/v1');
    }
}

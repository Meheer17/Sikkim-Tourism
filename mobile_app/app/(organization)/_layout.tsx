...
export default function OrganizationLayout() {
    ...
    const shouldShowTabBar = !pathname.includes('/(organization)/(stack)');
    ...
    return (
        <View style={styles.container}>
            ...
            >
                ...
                <Stack.Screen name="places" options={{ gestureEnabled: false }} />
                <Stack.Screen name="events" options={{ gestureEnabled: false }} />
                <Stack.Screen name="tickets" options={{ gestureEnabled: false }} />

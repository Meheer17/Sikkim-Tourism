    ...
    return (
        <View style={styles.container}>
            <View style={styles.header}>
                ...
                <TouchableOpacity style={styles.addBtn} onPress={() => router.push('/(organization)/(stack)/add-place' as any)}>
            ...
            <View style={styles.mapContainer}>
                <View style={styles.mapPlaceholder}>
                    ...
                    <Text style={styles.mapText}>{selectedPlace ? `Showing: ${selectedPlace}` : 'Select a place to view on map'}</Text>
                </View>
                <View style={styles.mapControls}>
                    <TouchableOpacity style={styles.controlButton}><IconSymbol name="location.fill" size={20} color="#0a7ea4" /></TouchableOpacity>
            ...
            <ScrollView style={styles.scroll} contentContainerStyle={styles.content}>
                {places.map(p => (
                    <TouchableOpacity key={p.id} style={styles.card} onPress={() => setSelectedPlace(p.name)}>
                        ...
                        <View style={styles.actions}>
                            <TouchableOpacity style={[styles.actionBtn, { backgroundColor: '#3b82f6' }]} onPress={() => router.push(`/(organization)/(stack)/edit-place?id=${p.id}` as any)}>

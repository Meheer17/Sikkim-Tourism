...
export default function AddEventScreen() {
    ...
    const eventTypeId = '000000000000000000000001'; // Placeholder

    const handleSubmit = async () => {
        if (!name.trim() || !description.trim() || !shortDescription.trim() || !latitude || !longitude || !eventDate) {
        ...
        try {
            ...
            if (resp.success) {
                ...
                Alert.alert('Error', resp.message || 'Failed to create event');
            }
        } catch (error: any) {
    ...
    return (
        <View style={[styles.container, { backgroundColor: background }]}>
            <View style={[styles.header, { backgroundColor: card }]}>
                ...
                <Text style={[styles.headerTitle, { color: text }]}>Add Event</Text>
            ...
            <ScrollView style={styles.scrollView} contentContainerStyle={styles.content}>
                <View style={[styles.card, { backgroundColor: card }]}>
                    ...
                    <Text style={[styles.sectionTitle, { color: text }]}>Event Schedule</Text>
